...
//       icon: MapPin,
//       title: 'Address',
//       content: '100 ft road block-B, Sant Nagar near Agrawal Sweet, Burari, Delhi - 110084',
//       action: 'Get Directions'
//     },
//     {
//       icon: Phone,
//       title: 'Phone',
//       content: '099909 91630',
//       action: 'Call Now'
//     },
//     {
//       icon: Mail,
//       title: 'Email',
//       content: 'signaturelibrary01@gmail.com',
//       action: 'Send Email'
//     },
//     {
//       icon: Clock,
...
//                 Located in the heart of Sant Nagar, Burari, our library is easily accessible and well-connected to major transportation routes.
//               </p>
...
//                     <div className="text-sm text-gray-600">099909 91630</div>
//                   </div>
//                 </a>

//                 <a
//                   href="mailto:signaturelibrary01@gmail.com"
...
//                     <div className="text-sm text-gray-600">signaturelibrary01@gmail.com</div>
//                   </div>
//                 </a>
...
//                 Take an auto-rickshaw or walk 5 minutes to Burari. We're located near the main market area.
//               </p>
//             </div>
...
//                 <MapPin className="h-6 w-6 text-primary-600" />
//               </div>
//               <h3 className="font-semibold text-gray-900 mb-2">From Burari</h3>
//               <p className="text-gray-600 text-sm">
...
//               <p className="text-gray-600 text-sm">
//                 Near Bikaner Sweets, opposite to Sant Nagar, next to FuncherShop Store.
//               </p>
//             </div>
//           </div>
//         </div>
...
import React, { useState } from 'react';
import { MapPin, Phone, Mail, Clock, Send, CheckCircle, Loader2 } from 'lucide-react'; // Loader2 import kiya gaya hai
...
const Contact = () => {
  ...
  const [isSubmitting, setIsSubmitting] = useState(false); // Nayi state: form submit ho raha hai ya nahi
  const [isSubmitted, setIsSubmitted] = useState(false);
  const [error, setError] = useState(''); // Nayi state: error message ke liye
  ...
  // Puraana handleSubmit function is naye function se replace ho gaya hai
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 5 seconds ke baad success message hata dein
      setTimeout(() => {
        setIsSubmitted(false);
      }, 5000);
    ...
    <div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      value={formData.message}
                      onChange={handleChange}
                      className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-300 bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm placeholder-gray-500 dark:placeholder-gray-400 dark:text-white resize-none"
                      placeholder="Tell us about your inquiry or requirements..."
                    />
                  </div>

                  {/* Submit button ko update kiya gaya hai */}
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full bg-gradient-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600 text-white px-6 py-4 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-primary-100 dark:border-gray-700">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-lg mb-6 border border-primary-100">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3497.894311219602!2d77.19833547423309!3d28.75239917849853!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d019318181a49%3A0x63394121288f832!2sAgrawal%20Sweets%20Corner!5e0!3m2!1sen!2sin!4v1723635951608!5m2!1sen!2sin"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen={true}
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-primary-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/90 dark:bg-gray-800/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-primary-100 dark:border-gray-700">
              <div className="bg-gradient-to-r from-primary-100 to-secondary-100 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                <MapPin className="h-6 w-6 text-primary-600" />
              </div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">From Bus Stand</h3>
            ...
            <div className="bg-white/90 dark:bg-gray-800/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-primary-100 dark:border-gray-700">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">From Burari</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                15-minute drive by taxi or auto-rickshaw. Public buses are also available every 30 minutes.
              </p>
            </div>
            ...
            <div className="bg-white/90 dark:bg-gray-800/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-primary-100 dark:border-gray-700">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Landmarks</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Near Bikaner Sweets, opposite to Sant Nagar, next to FuncherShop Store.
              </p>
            </div>
